...
export function ZoomControls({ zoomPercent, onZoomIn, onZoomOut, onReset, onFit }: ZoomControlsProps) {
  return (
    <div className="group flex items-center gap-2 bg-[var(--bg-secondary)]/80 backdrop-blur border border-[var(--border-muted)] rounded-xl px-2 py-1.5 scale-90 opacity-60 hover:scale-100 hover:opacity-100 hover:px-3 hover:py-2 transition-all duration-200 ease-out">
