...
class TopologyMarkerRouterTests(unittest.TestCase):
    def test_routes_arrow_connection_and_node_classes(self) -> None:
        ...
        self.assertEqual(result["summary"]["class_counts"]["page connection"], 1)
        self.assertEqual(result["summary"]["class_counts"]["node"], 1)
        self.assertEqual(result["summary"]["role_counts"]["flow_marker"], 1)
        self.assertEqual(result["summary"]["role_counts"]["connection_marker"], 1)
